...
class screan_share_tool_by_rocky(object):
        ...
        if os.path.isdir(self.minecraft_path + "/mods/1.8.9"):
         for x in os.listdir(path2): 
            if x.endswith('.jar'):
                ...
                if self.is_raven(self.minecraft_path + "/mods/1.8.9/"+x): print(self.color_red + x + " es un raven ghost client"+ self.color_clear)
                else: print(self.color_yellow + x + self.color_clear)
         ...
         for x in os.listdir(path3): 
          if x.endswith('.jar'):
            if "$ . class" in self.show_jar_classes(self.minecraft_path + "/mods/1.7.10/"+x): print(self.color_red + x + " (Injected)"+ self.color_clear)
                ...
                if self.is_raven(self.minecraft_path + "/mods/1.7.10/"+x): print(self.color_red + x + " es un raven ghost client"+ self.color_clear)
                else: print(self.color_yellow + x + self.color_clear)
         ...
         for x in os.listdir(path4): 
          if x.endswith('.jar'):
            if "$ . class" in self.show_jar_classes(self.minecraft_path + "/mods/1.7/"+x): print(self.color_red + x + " (Injected)"+ self.color_clear)
                ...
                if self.is_raven(self.minecraft_path + "/mods/1.7/"+x): print(self.color_red + x + " es un raven ghost client"+ self.color_clear)
                else: print(self.color_yellow + x + self.color_clear)
    ...
    def check_strings(self):
        ...
        if found:
            ...
            print(self.color_green+f'    Ningun hack encontrado en Pcasvc'+self.color_clear)
